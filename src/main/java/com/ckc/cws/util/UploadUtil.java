...
import com.ckc.cws.entity.common.ScaleImage;
...
public class UploadUtil
{
	...
	public String uploadImage1(HttpServletRequest request,MultipartFile file, String getUploadContentType, String getUploadFileName) throws IOException
	{
		...
		LOGGER.debug(" 回图片路径   " + file.getInputStream());
		LOGGER.debug(" //最后返回图片路径   " + imagePath);

		BufferedImage srcBufferImage = ImageIO.read(file.getInputStream());
		LOGGER.debug(" w " + srcBufferImage.getWidth() + " w " + srcBufferImage.getHeight());
